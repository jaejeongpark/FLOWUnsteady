...
save_path       = "vahana-example-mid-sim_vcr15_rpm1200"# Where to save this simulation
...
# Maneuver settings
Vcruise         = 15.0                      # (m/s) cruise speed (reference) 15
RPMh_w          = 1200.0                     # RPM of main-wing rotors in hover (reference) 600
